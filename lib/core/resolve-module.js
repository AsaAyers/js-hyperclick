...
import type { Resolved, SuggestionFromImport, PathSuggestion } from '../types'
...
export default function resolveModule(filePath: string, suggestion: SuggestionFromImport | PathSuggestion, options: ResolveOptions = {}): Resolved {
    const { extensions = defaultExtensions } = options
